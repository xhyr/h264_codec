...
void InterP8x16ChromaPredictor::Decide()
{
	...
	auto origin_block_data = m_mb->GetOriginalChromaBlockData4x8(PlaneType::Cb, m_segment_index);
	...
	origin_block_data = m_mb->GetOriginalChromaBlockData4x8(PlaneType::Cr, m_segment_index);
