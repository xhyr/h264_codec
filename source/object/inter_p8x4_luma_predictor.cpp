...
{
	predicted_data.SetBlock4x4(0, m_sub_segment_index, m_predicted_data.GetBlock4x4<uint8_t>(0, 0));
	predicted_data.SetBlock4x4(1, m_sub_segment_index, m_predicted_data.GetBlock4x4<uint8_t>(1, 0));
}
