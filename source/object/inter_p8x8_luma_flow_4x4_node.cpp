...
InterP8x8LumaFlow4x4Node::InterP8x8LumaFlow4x4Node(std::shared_ptr<Macroblock> mb, std::shared_ptr<EncoderContext> encoder_context, uint8_t segment_index) :
	InterP8x8LumaFlowNodeBase(mb, encoder_context, segment_index, MBType::SMB4x4)
{
	Init();
}

InterP8x8LumaFlow4x4Node::~InterP8x8LumaFlow4x4Node()
{
}

void InterP8x8LumaFlow4x4Node::Predict()
{
...
void InterP8x8LumaFlow4x4Node::FillDiffData(std::vector<BlockData<4, 4, int32_t>>& diff_datas) const
{
	for (uint8_t i = 0; i < 4; ++i)
		m_predictors[i]->FillDiffData(diff_datas);
}

void InterP8x8LumaFlow4x4Node::UpdateMotionInfo()
{
	for (uint8_t i = 0; i < 4; ++i)
		m_predictors[i]->UpdateMotionInfo();
}

uint32_t InterP8x8LumaFlow4x4Node::OutputMotionInfos(std::shared_ptr<BytesData> bytes_data) const
{
...
void InterP8x8LumaFlow4x4Node::Init()
{
